...
const int YY_parse_CLASS::IDEN=260;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 260 ? yytranslate[x] : 25)

static const char yytranslate[] = {     0,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,    15,     2,     2,     2,     2,     2,     2,    11,
    12,     9,     7,     2,     8,     2,    10,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,    18,    13,
     6,    14,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
     2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
static const short yyprhs[] = {     0,
     0,     4,     8,    12,    16,    18,    20,    22,    25,    28,
    31,    34,    36,    38,    40,    42,    43,    48,    50,    52,
    54,    57,    58,    62,    66,    70,    74,    78,    80
};

static const short yyrhs[] = {     3,
    20,    23,     0,    11,    21,    12,     0,     5,    22,     5,
     0,     5,    22,     4,     0,     5,     0,    13,     0,    14,
     0,    13,     6,     0,    14,     6,     0,     6,     6,     0,
    15,     6,     0,     7,     0,     8,     0,     9,     0,    10,
     0,     0,    16,    24,    23,    17,     0,    24,     0,    18,
     0,    19,     0,    21,    18,     0,     0,     5,     6,    21,
     0,    21,     7,    21,     0,    21,     8,    21,     0,    21,
     9,    21,     0,    21,    10,    21,     0,     5,     0,     4,
     0
};
...
static const short yyrline[] = { 0,
    17,    20,    23,    24,    25,    28,    28,    28,    28,    28,
    28,    28,    28,    28,    28,    28,    30,    31,    32,    35,
    36,    37,    40,    41,    42,    43,    44,    45,    46
};

static const char * const yytname[] = {   "$","error","$illegal.","IF","NUM",
"IDEN","'='","'+'","'-'","'*'","'/'","'('","')'","'<'","'>'","'!'","'{'","'}'",
"';'","S","A","E","OP","B","STM",""
};
#endif
...
static const short yydefact[] = {     0,
     0,     0,    22,    29,     5,     0,    22,    19,    20,     0,
     1,    18,     0,    12,    13,    14,    15,     6,     7,     0,
     0,     0,     0,     0,     0,     2,    22,    21,    10,    23,
     8,     9,    11,     4,     3,    24,    25,    26,    27,     0,
    17,     0,     0,     0
};
...
static const short yypact[] = {    13,
   -10,     1,    -1,-32768,    20,    29,     9,-32768,-32768,     0,
-32768,-32768,    42,-32768,-32768,-32768,-32768,    34,    45,    46,
    27,     1,     1,     1,     1,-32768,    -1,-32768,-32768,    35,
-32768,-32768,-32768,-32768,-32768,    40,    40,-32768,-32768,     2,
-32768,    53,    54,-32768
};
...
static const short yytable[] = {     6,
     2,     1,     4,     5,     4,     5,    22,    23,    24,    25,
    30,     1,     4,     5,     7,     1,     8,    28,    41,    36,
    37,    38,    39,   -16,   -16,    13,    14,    15,    16,    17,
    34,    35,    18,    19,    20,    22,    23,    24,    25,    31,
    26,    22,    23,    24,    25,     4,     5,    29,    24,    25,
    32,    33,    43,    44,    42,    27,    40
};

static const short yycheck[] = {     2,
    11,     3,     4,     5,     4,     5,     7,     8,     9,    10,
    13,     3,     4,     5,    16,     3,    18,    18,    17,    22,
    23,    24,    25,     4,     5,     6,     7,     8,     9,    10,
     4,     5,    13,    14,    15,     7,     8,     9,    10,     6,
    12,     7,     8,     9,    10,     4,     5,     6,     9,    10,
     6,     6,     0,     0,     0,     7,    27
};
