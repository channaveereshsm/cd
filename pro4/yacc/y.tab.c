...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from yaac.y  */
...
const int YY_parse_CLASS::IDEN=259;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 260 ? yytranslate[x] : 27)
...
static const short yyprhs[] = {     0,
     0,     2,     6,    14,    18,    22,    25,    27,    29,    31,
    33,    36,    39,    42,    45,    48,    51,    56,    58,    60,
    62,    65,    66,    70,    74,    78,    82,    86,    88
};

static const short yyrhs[] = {    19,
     0,     3,    20,    24,     0,     6,    21,     7,    21,     7,
    21,     8,     0,     4,    22,     4,     0,     4,    22,     5,
     0,     4,    23,     0,     4,     0,     9,     0,    10,     0,
    11,     0,    11,     9,     0,    10,     9,     0,     9,    12,
     0,     9,    13,     0,    12,    12,     0,    13,    13,     0,
    14,    25,    24,    15,     0,    25,     0,     7,     0,    19,
     0,    26,     7,     0,     0,     4,     9,    26,     0,    26,
    12,    26,     0,    26,    13,    26,     0,    26,    16,    26,
     0,    26,    17,    26,     0,     4,     0,     5,     0
};
...
static const short yyrline[] = { 0,
    10,    12,    14,    16,    17,    18,    19,    21,    21,    21,
    21,    21,    21,    21,    23,    23,    25,    26,    27,    30,
    31,    32,    35,    36,    37,    38,    39,    40,    41
};

static const char * const yytname[] = {   "$","error","$illegal.","FOR","IDEN",
"NUM","'('","';'","')'","'='","'>'","'<'","'+'","'-'","'{'","'}'","'*'","'/'",
"S","I","A","E","Z","U","B","STMT","E1",""
};
#endif

static const short yyr1[] = {     0,
    18,    19,    20,    21,    21,    21,    21,    22,    22,    22,
...
static const short yydefact[] = {     0,
     0,     1,     0,    22,     7,     0,    28,    29,    19,    22,
    20,     2,    18,     0,     8,     9,    10,     0,     0,     0,
     6,     0,     0,    22,    21,     0,     0,     0,     0,    13,
    14,    12,    11,    15,    16,     4,     5,     0,    23,     0,
    24,    25,    26,    27,     0,    17,     0,     3,     0,     0,
     0
};

static const short yydefgoto[] = {    49,
    11,     4,     6,    20,    21,    12,    13,    14
};

static const short yypact[] = {     8,
    16,-32768,    33,    -2,    21,    32,    29,-32768,-32768,     3,
-32768,-32768,-32768,    -3,     4,    34,    35,    28,    36,    22,
-32768,    33,    31,    -2,-32768,    31,    31,    31,    31,-32768,
-32768,-32768,-32768,-32768,-32768,-32768,-32768,    38,    12,    26,
    12,    12,    12,    12,    33,-32768,    39,-32768,    42,    46,
-32768
};

static const short yypgoto[] = {-32768,
    48,-32768,   -22,-32768,-32768,    27,    40,    -8
};
...
static const short yytable[] = {    38,
     1,     7,     8,    25,     9,     1,     7,     8,    26,    27,
     1,    10,    28,    29,    39,    30,    31,    41,    42,    43,
    44,     3,    47,    26,    27,    36,    37,    28,    29,    15,
    16,    17,    18,    19,     7,     8,     5,    23,    22,    34,
    46,    50,    32,    33,    45,    51,    48,     2,    35,    24,
    40
};

static const short yycheck[] = {    22,
     3,     4,     5,     7,     7,     3,     4,     5,    12,    13,
     3,    14,    16,    17,    23,    12,    13,    26,    27,    28,
    29,     6,    45,    12,    13,     4,     5,    16,    17,     9,
    10,    11,    12,    13,     4,     5,     4,     9,     7,    12,
    15,     0,     9,     9,     7,     0,     8,     0,    13,    10,
    24
};
